...
<body>
	<div style="font-family: arial,helvetica neue,helvetica,sans-serif; font-size: 14px; background: #fff; line-height: 1.5; border: 2px solid #eceded; background: #fff; width: 100%; max-width: 600px; margin: 0 auto;">
		...
		<div align="center" style="text-align: center; margin: 20px; padding: 0">
			<a href="" target="_blank" style="color: #fff; text-decoration: none; display: inline-block; text-align: center; padding: 12px 16px; border-radius: 0; font-size: 15px; line-height: 1.3; font-weight: lighter; min-width: 20%; max-width: 50%; overflow: hidden; word-wrap: break-word; background-color: #f26039">Pesan Sekarang</a> 
		</div>
