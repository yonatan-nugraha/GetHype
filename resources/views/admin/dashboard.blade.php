        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-8">
                        <p class="text-center">
                            <strong>Sales: {{ $last_month->format('d M, Y') .' - '. $today->format('d M, Y') }}</strong>
                        </p>
                        <div class="chart">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="progress-group">
                            ...
                            <span class="progress-number"><b>{{ $users }}</b>/20</span>

                            <div class="progress sm">
                                <div class="progress-bar progress-bar-aqua" style="width: {{ ($users/20) * 100 }}%"></div>
                            </div>
                        </div>
                        <div class="progress-group">
                            <span class="progress-text">Collect Events</span>
                            <span class="progress-number"><b>{{ $events }}</b>/20</span>

                            <div class="progress sm">
                                <div class="progress-bar progress-bar-red" style="width: {{ ($events/20) * 100 }}%"></div>
                            </div>
                        </div>
                        <div class="progress-group">
                            <span class="progress-text">Complete Purchase</span>
                            <span class="progress-number"><b>{{ $orders }}</b>/20</span>

                            <div class="progress sm">
                                <div class="progress-bar progress-bar-green" style="width: {{ ($orders/20) * 100 }}%"></div>
                            </div>
                        </div>
                        <div class="progress-group">
                            <span class="progress-text">Sell Tickets</span>
                            <span class="progress-number"><b>{{ $tickets }}</b>/20</span>

                            <div class="progress sm">
                                <div class="progress-bar progress-bar-yellow" style="width: {{ ($tickets/20) * 100 }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="description-block">
                            ...
                            <h5 class="description-header">{{ $users + $events + $orders + $tickets }}</h5>
